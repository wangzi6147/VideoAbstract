...
IMPLEMENT_DYNAMIC(DrawDetectionSUBDlg, CDialogEx)

DrawDetectionSUBDlg::DrawDetectionSUBDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(DrawDetectionSUBDlg::IDD, pParent)
{
...
DrawDetectionSUBDlg::~DrawDetectionSUBDlg()
{
}

void DrawDetectionSUBDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(DrawDetectionSUBDlg, CDialogEx)
	ON_WM_TIMER()
	ON_BN_CLICKED(IDC_BTN_PLAY_IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedBtnPlayInDrawDetect)
	ON_BN_CLICKED(IDC_BTN_PAUSE_IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedBtnPauseInDrawDetect)
	ON_BN_CLICKED(IDC_BTN_STOP_IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedBtnStopInDrawDetect)
	ON_BN_CLICKED(IDC_BTN_START_PROCESS__IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedBtnStartProcess)
	ON_BN_CLICKED(IDC_BTN_STOP_PROCESS, &DrawDetectionSUBDlg::OnBnClickedBtnStopProcess)
	ON_BN_CLICKED(IDC_CHECK_LINE_IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedCheckLineInDrawDetect)
	ON_BN_CLICKED(IDC_CHECK_RECT_IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedCheckRectInDrawDetect)
	ON_BN_CLICKED(IDC_BTN_CLEAR_IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedBtnClearInDrawDetect)
	ON_BN_CLICKED(IDC_BTN_SEARCH_IN_DRAW_DETECT, &DrawDetectionSUBDlg::OnBnClickedBtnSearchInDrawDetect)
	ON_BN_CLICKED(IDC_BTN_PLAY_IN_DRAW_DETECT2, &DrawDetectionSUBDlg::OnBnClickedBtnPlayInDrawDetect2)
	ON_BN_CLICKED(IDC_BTN_PAUSE_IN_DRAW_DETECT2, &DrawDetectionSUBDlg::OnBnClickedBtnPauseInDrawDetect2)
	ON_BN_CLICKED(IDC_BTN_STOP_IN_DRAW_DETECT2, &DrawDetectionSUBDlg::OnBnClickedBtnStopInDrawDetect2)
	ON_WM_LBUTTONUP()
	ON_WM_HSCROLL()
END_MESSAGE_MAP()


// DrawDetectionSUBDlg 消息处理程序


BOOL DrawDetectionSUBDlg::OnInitDialog()
{
	...
	UIBeautifier.LoadButtonBitmaps(Btn_BTN1_DRAW_STOP, IDB_STOP_U, IDB_STOP_D, 180.0 / 1214, 400.0/ 760, 210.0 / 1214,430.0/ 760);
	UIBeautifier.LoadButtonBitmaps(Btn_BTN2_DRAW_PLAY, IDB_PLAY_U, IDB_PLAY_D, 540.0 / 1214, 400.0 / 760, 570.0 / 1214, 430.0 / 760);
	UIBeautifier.LoadButtonBitmaps(Btn_BTN2_DRAW_PAUSE, IDB_PAUSE_U, IDB_PAUSE_D, 580.0 / 1214, 400.0 / 760, 610.0 / 1214, 430.0 / 760);
	UIBeautifier.LoadButtonBitmaps(Btn_BTN2_DRAW_STOP, IDB_STOP_U, IDB_STOP_D, 620.0 / 1214, 400.0 / 760, 650.0 / 1214, 430.0 / 760);
	///左播放器初始化
	//player.m_filePath = "";
...
void DrawDetectionSUBDlg::OnTimer(UINT_PTR nIDEvent)
{
	if (nIDEvent==1)
	{
		///刷新进度条
...
///@brief DrawDetectionSUBDlg类的原始视频窗口的暂停按钮响应函数
/// 
///@param[in|out] NULL
///@pre  NULL
///@return NULL
///@retval NULL
///@post NULL
void DrawDetectionSUBDlg::OnBnClickedBtnPauseInDrawDetect()
{
	// TODO: 在此添加控件通知处理程序代码
	if (player.m_filePath=="")
	{
...
///@brief DrawDetectionSUBDlg类的原始视频窗口的中止按钮响应函数
/// 
///@param[in|out] NULL
///@pre  NULL
///@return NULL
///@retval NULL
///@post NULL
void DrawDetectionSUBDlg::OnBnClickedBtnStopInDrawDetect()
{
	// TODO: 在此添加控件通知处理程序代码
	if (player.m_filePath=="")
	{
...
void DrawDetectionSUBDlg::OnBnClickedBtnStartProcess()
{
	// TODO: 在此添加控件通知处理程序代码
...
void DrawDetectionSUBDlg::OnBnClickedBtnStopProcess()
{
	// TODO: 在此添加控件通知处理程序代码
...
void DrawDetectionSUBDlg::OnBnClickedCheckLineInDrawDetect()
{
	// TODO: 在此添加控件通知处理程序代码
...
void DrawDetectionSUBDlg::OnBnClickedCheckRectInDrawDetect()
{
	// TODO: 在此添加控件通知处理程序代码
		if(!m_ifExistProData)
	{///存在数据表则无需再做处理
...
void DrawDetectionSUBDlg::OnBnClickedBtnClearInDrawDetect()
{
	// TODO: 在此添加控件通知处理程序代码
	if (tracker.m_IfContinue)
	{
...
void DrawDetectionSUBDlg::OnBnClickedBtnSearchInDrawDetect()
{
	// TODO: 在此添加控件通知处理程序代码
	m_curVideoPath=player.m_filePath;
	if (m_curVideoPath == "")
...
void DrawDetectionSUBDlg::DisplayPageSumImg()
{
...
void DrawDetectionSUBDlg::DetectResult()
{
	///得到过线或过框的所有物体信息
...
void DrawDetectionSUBDlg::OnBnClickedBtnPlayInDrawDetect2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (tracker.m_IfContinue)
	{
...
void DrawDetectionSUBDlg::OnBnClickedBtnPauseInDrawDetect2()
{
	// TODO: 在此添加控件通知处理程序代码
	if (tracker.m_IfContinue)
	{
...
void DrawDetectionSUBDlg::OnBnClickedBtnStopInDrawDetect2()
{
	// TODO: 在此添加控件通知处理程序代码
...
void DrawDetectionSUBDlg::OnLButtonUp(UINT nFlags, CPoint point)
{
...
void DrawDetectionSUBDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
