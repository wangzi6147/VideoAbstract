...
public:
	...
	bool GetCaseImgDataFromImageTable(vector<ImageTable> *caseAllImgData,CString caseName);          ///<获	得某一记录下所有图片的路径
	///
	///线索表的相关函数
	///	
	...
	bool GetObjectOriMidFrameFromVideoFgTable(vector<objectInfo> *objDetectedInfos,CString FGTraceTable);//寻找物体的中间帧
	///
	...
	bool FindROIFromCombineSegsTable(vector <OrigTraceTable> *myVector, CString tableName);						///获得所有ROI
