...
IMPLEMENT_DYNAMIC(picsum, CDialogEx)

picsum::picsum(CWnd* pParent /*=NULL*/)
	: CDialogEx(picsum::IDD, pParent)
{
...
void picsum::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(picsum, CDialogEx)
	ON_BN_CLICKED(IDC_BTN_TAB2_COMBINEPIC_UP, &picsum::OnBnClickeddlg2up)
	ON_BN_CLICKED(IDC_BTN_TAB2_COMBINEPIC_down, &picsum::OnBnClickeddlg2down)
//	ON_BN_CLICKED(IDC_BTN_TAB2_COMBINEPIC_GENERATE, &picsum::OnBnClickeddlg2generate)
	ON_BN_CLICKED(IDC_BTN_TAB2_ORI_PLAY, &picsum::OnBnClickedBtnTab2OriPlay)
	ON_BN_CLICKED(IDC_BTN_TAB2_ORI_PAUSE, &picsum::OnBnClickedBtnTab2OriPause)
	ON_BN_CLICKED(IDC_BTN_TAB2_ORI_STOP, &picsum::OnBnClickedBtnTab2OriStop)
	ON_WM_TIMER()
	ON_WM_CLOSE()
	ON_WM_PAINT()
END_MESSAGE_MAP()
...
void picsum::OnBnClickeddlg2down()
{
	// TODO:  在此添加控件通知处理程序代码
	IplImage* image = NULL;
	CString PicName;
...
//void picsum::OnBnClickeddlg2generate()
//{
//	// TODO:  在此添加控件通知处理程序代码
//	m_pagenum = 0;
//	Generated = TRUE;
...
BOOL picsum::OnInitDialog()
{
	...
	GetDlgItem(IDC_TAB2_ORI_SLIDER)->MoveWindow(581.0*UIBeautifier.rcDeskRect.Width() / 1214, 490.0*UIBeautifier.rcDeskRect.Height() / 760, 506.0*UIBeautifier.rcDeskRect.Width() / 1214, 20.0*UIBeautifier.rcDeskRect.Height() / 760);
	GetDlgItem(IDC_STATIC_TAB2_ORI_TIME)->MoveWindow(950.0*UIBeautifier.rcDeskRect.Width() / 1214, 510.0*UIBeautifier.rcDeskRect.Height() / 760, 100.0*UIBeautifier.rcDeskRect.Width() / 1214, 20.0*UIBeautifier.rcDeskRect.Height() / 760);

	UIBeautifier.LoadButtonBitmaps(Btn_TAB2_PLAY, IDB_PLAY_U, IDB_PLAY_D,581.0/ 1214, 510.0 / 760, 611.0 / 1214, 540.0 / 760);
	UIBeautifier.LoadButtonBitmaps(Btn_TAB2_PAUSE,IDB_PAUSE_U, IDB_PAUSE_D, 631.0 / 1214, 510.0 / 760, 661.0 / 1214, 540.0 / 760);
	UIBeautifier.LoadButtonBitmaps(Btn_TAB2_STOP, IDB_STOP_U, IDB_STOP_D, 681.0 / 1214, 510.0 / 760, 711.0 / 1214, 540.0 / 760);
...
void picsum::OnBnClickedBtnTab2OriPlay()
{
	// TODO:  在此添加控件通知处理程序代码
...
void picsum::OnBnClickedBtnTab2OriPause()
{
	// TODO:  在此添加控件通知处理程序代码
...
void picsum::OnBnClickedBtnTab2OriStop()
{
	// TODO:  在此添加控件通知处理程序代码
	playerori_TAB2.stop();
}
...
void picsum::OnTimer(UINT_PTR nIDEvent)
{
...
void picsum::ShowTime(int m_currentFrameNO, int totalFrameCount, int videoTimeInSecond, CWnd *m_pShowTimeWnd, int flag)
{
